...
You can retrieve an order batch by calling the [GET /order_batches/:id](/api-reference/orders/retrieve-an-order) endpoint, or retrieve orders inside the order batch using the [GET /orders/:id/orders](../../goody-api-openapi.json/paths/~1v1~1order_batches~1{id}~1orders) endpoint.
